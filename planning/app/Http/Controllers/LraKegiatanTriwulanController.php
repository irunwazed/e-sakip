...
class LraKegiatanTriwulanController extends Controller
{
    private $table, $jenis;

    public function __construct() {
        $this->table = 'rpjmd_triwulan_kegiatan';
    }
    ...
    public function index($kode)
    {
    	...
    	return view('admin/conponents/lra-kegiatan-triwulan',$kirim);
    }
    ...
    public function update(Request $request){
        ...
        if (!$validator->fails()) {
            ...
            $status = DB::table($this->table)
                        ...
                        ->where("rpjmd_triwulan_jenis", $kode[5])
