...
@section('content') 
<?php
$judul = "Data Realisasi Anggaran Sub Kegiatan";
$des = "";
?>
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="{{ url('') }}/lra-kegiatan/{{ $kode }}" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                ...
                kodeTampil,
                namaJenis,
                '<a href="{{ url("") }}/lra-triwulan/'+kodeOneData+'">'+element['rkpd_'+jenis+'_sub_kegiatan_nama']+'</a>',
