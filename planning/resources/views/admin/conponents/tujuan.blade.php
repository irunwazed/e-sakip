                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="{{ url('') }}/misi/{{ $kode }}" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        <label>Tujuan</label>
                        <input name="rpjmd_tujuan_nama" type="text" class="form-control" required>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                no,
                '<a href="{{ url("") }}/sasaran/'+kodeOneData+'">'+element['rpjmd_tujuan_nama']+'</a>',
                '<a class="btn btn-info" href="{{ url("") }}/tujuan-indikator/'+kodeOneData+'"><i class="fa fa-search"></i></a>',                
    ...
    function setForm(data){
        ...
        $("input[name='rpjmd_tujuan_nama']").val(data['rpjmd_tujuan_nama']);
