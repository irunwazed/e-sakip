                ...
                <form id="form-data">
                    ...
                    <div class="row">
                        <div class="position-relative form-group col-sm-6">
                            ...
                            <textarea name="rpjmd_kegiatan_indikator" class="form-control" required></textarea>
                        </div>
                        <div class="position-relative form-group col-sm-6">
                            <label>Formula</label>
                            <textarea name="rpjmd_kegiatan_formula" class="form-control" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="position-relative form-group">
                                ...
                                <input name="rpjmd_kegiatan_th0_target_kinerja" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Kinerja Tahun <?=@$dataAsal->rpjmd_tahun?></label>
                                <input name="rpjmd_kegiatan_th1_target_kinerja" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Kinerja Tahun <?=@$dataAsal->rpjmd_tahun+1?></label>
                                <input name="rpjmd_kegiatan_th2_target_kinerja" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Kinerja Tahun <?=@$dataAsal->rpjmd_tahun+2?></label>
                                <input name="rpjmd_kegiatan_th3_target_kinerja" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Kinerja Tahun <?=@$dataAsal->rpjmd_tahun+3?></label>
                                <input name="rpjmd_kegiatan_th4_target_kinerja" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Kinerja Tahun <?=@$dataAsal->rpjmd_tahun+4?></label>
                                <input name="rpjmd_kegiatan_th5_target_kinerja" type="text" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-4">
                            <div class="position-relative form-group">
                                ...
                                <input name="rpjmd_kegiatan_th0_target_realisasi" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Realisasi Tahun <?=@$dataAsal->rpjmd_tahun?></label>
                                <input name="rpjmd_kegiatan_th1_target_realisasi" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Realisasi Tahun <?=@$dataAsal->rpjmd_tahun+1?></label>
                                <input name="rpjmd_kegiatan_th2_target_realisasi" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Realisasi Tahun <?=@$dataAsal->rpjmd_tahun+2?></label>
                                <input name="rpjmd_kegiatan_th3_target_realisasi" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Realisasi Tahun <?=@$dataAsal->rpjmd_tahun+3?></label>
                                <input name="rpjmd_kegiatan_th4_target_realisasi" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="position-relative form-group">
                                <label>Target Realisasi Tahun <?=@$dataAsal->rpjmd_tahun+4?></label>
                                <input name="rpjmd_kegiatan_th5_target_realisasi" type="text" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <hr>
...
<script type="text/javascript">
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                ...
                element['satuan_nama'],
                element['rpjmd_kegiatan_th0_target_kinerja'],
                element['rpjmd_kegiatan_th1_target_kinerja'],
                element['rpjmd_kegiatan_th2_target_kinerja'],
                element['rpjmd_kegiatan_th3_target_kinerja'],
                element['rpjmd_kegiatan_th4_target_kinerja'],
                element['rpjmd_kegiatan_th5_target_kinerja'],
                element['rpjmd_kegiatan_th0_target_realisasi'],
                element['rpjmd_kegiatan_th1_target_realisasi'],
                element['rpjmd_kegiatan_th2_target_realisasi'],
                element['rpjmd_kegiatan_th3_target_realisasi'],
                element['rpjmd_kegiatan_th4_target_realisasi'],
                element['rpjmd_kegiatan_th5_target_realisasi'],
    ...
    function setForm(data){
        ...
        $("textarea[name='rpjmd_kegiatan_indikator']").val(data['rpjmd_kegiatan_indikator']);
        $("textarea[name='rpjmd_kegiatan_formula']").val(data['rpjmd_kegiatan_formula']);
        $("select[name='id_satuan']").val(data['id_satuan']);
        $("input[name='rpjmd_kegiatan_th0_target_kinerja']").val(data['rpjmd_kegiatan_th0_target_kinerja']);
        $("input[name='rpjmd_kegiatan_th1_target_kinerja']").val(data['rpjmd_kegiatan_th1_target_kinerja']);
        $("input[name='rpjmd_kegiatan_th2_target_kinerja']").val(data['rpjmd_kegiatan_th2_target_kinerja']);
        $("input[name='rpjmd_kegiatan_th3_target_kinerja']").val(data['rpjmd_kegiatan_th3_target_kinerja']);
        $("input[name='rpjmd_kegiatan_th4_target_kinerja']").val(data['rpjmd_kegiatan_th4_target_kinerja']);
        $("input[name='rpjmd_kegiatan_th5_target_kinerja']").val(data['rpjmd_kegiatan_th5_target_kinerja']);
        $("input[name='rpjmd_kegiatan_th0_target_realisasi']").val(data['rpjmd_kegiatan_th0_target_realisasi']);
        $("input[name='rpjmd_kegiatan_th1_target_realisasi']").val(data['rpjmd_kegiatan_th1_target_realisasi']);
        $("input[name='rpjmd_kegiatan_th2_target_realisasi']").val(data['rpjmd_kegiatan_th2_target_realisasi']);
        $("input[name='rpjmd_kegiatan_th3_target_realisasi']").val(data['rpjmd_kegiatan_th3_target_realisasi']);
        $("input[name='rpjmd_kegiatan_th4_target_realisasi']").val(data['rpjmd_kegiatan_th4_target_realisasi']);
        $("input[name='rpjmd_kegiatan_th5_target_realisasi']").val(data['rpjmd_kegiatan_th5_target_realisasi']);
    }
