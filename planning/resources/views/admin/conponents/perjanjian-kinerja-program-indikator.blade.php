...
@section('content') 
<?php
$judul = "Perjanjian Kinerja Program Indikator";
$des = "";
?>
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="{{ url('') }}/perjanjian-kinerja-program" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><?=@$dataAsal->perjanjian_kinerja_program_nama?></td>
                                            </tr>
                                        </table>
                ...
                <form id="form-data">
                    ...
                    <div class="row">
                        <div class="position-relative form-group col-sm-3">
                            ...
                            <input name="perjanjian_kinerja_program_indikator_kode" type="number" class="form-control" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="position-relative form-group col-sm-6">
                            <label>Indikator</label>
                            <textarea name="perjanjian_kinerja_program_indikator_nama" class="form-control" required></textarea>
                        </div>
                        <div class="position-relative form-group col-sm-6">
                            <label>Formula</label>
                            <textarea name="perjanjian_kinerja_program_indikator_formula" class="form-control" required></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="position-relative form-group col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="position-relative form-group">
                                ...
                                <input name="perjanjian_kinerja_program_indikator_target_kinerja" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="position-relative form-group">
                                <label>Target Realisasi</label>
                                <input name="perjanjian_kinerja_program_indikator_target_realisasi" type="text" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <!-- <hr>
...
<script type="text/javascript">
    ...
    var link = 'perjanjian-kinerja-program-indikator';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            kodeOneData = element['kota_kode']
                        ...
                        +'-'+element['perjanjian_kinerja_program_indikator_kode'];

            kodeTampil = element['perjanjian_kinerja_program_indikator_kode'];
            
            tempData = [
                no,
                kodeTampil,
                element['perjanjian_kinerja_program_indikator_nama'],
                element['perjanjian_kinerja_program_indikator_formula'],
                element['satuan_nama'],
                element['perjanjian_kinerja_program_indikator_target_kinerja'],
                element['perjanjian_kinerja_program_indikator_target_realisasi'],
    ...
    function getDataPilih(id){
        ...
        dataAll.forEach(element => {
            ...
            && setKode[6] == element['perjanjian_kinerja_program_indikator_kode'] ){
                dataPilih = element;
                kode = id;
            }
        });
    ...
    function setForm(data){
        ...
        $("input[name='perjanjian_kinerja_program_indikator_kode']").val(data['perjanjian_kinerja_program_indikator_kode']);
        $("textarea[name='perjanjian_kinerja_program_indikator_nama']").val(data['perjanjian_kinerja_program_indikator_nama']);
        $("textarea[name='perjanjian_kinerja_program_indikator_formula']").val(data['perjanjian_kinerja_program_indikator_formula']);
        $("select[name='id_satuan']").val(data['id_satuan']);
        $("input[name='perjanjian_kinerja_program_indikator_target_kinerja']").val(data['perjanjian_kinerja_program_indikator_target_kinerja']);
        $("input[name='perjanjian_kinerja_program_indikator_target_realisasi']").val(data['perjanjian_kinerja_program_indikator_target_realisasi']);
    }
