                ...
                <form id="form-data">
                    ...
                    <div class="row">
                        <div class="position-relative form-group col-sm-3">
                            ...
                            <input name="rkpd_perubahan_program_kode" type="number" class="form-control" required>
                        </div>
                    </div>
                    <div class="position-relative form-group">
                        <label>Program</label>
                        <input name="rkpd_perubahan_program_nama" type="text" class="form-control" required>
                    </div>
                    <div class="row">
                        <div class="position-relative form-group col-sm-6">
                            <label>Indikator</label>
                            <textarea name="rkpd_perubahan_program_indikator_nama" class="form-control" required></textarea>
                        </div>
                        <div class="position-relative form-group col-sm-6">
                            <label>Formula</label>
                            <textarea name="rkpd_perubahan_program_indikator_formula" class="form-control" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="position-relative form-group">
                                ...
                                <input name="rkpd_perubahan_program_indikator_target_kinerja" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="position-relative form-group">
                                <label>Target Realisasi</label>
                                <input name="rkpd_perubahan_program_indikator_target_realisasi" type="text" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="position-relative form-group">
                        <label>Catatan</label>
                        <textarea name="rkpd_perubahan_program_ket" type="text" class="form-control" required></textarea>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    function setTable(data) {
        ...
        data.forEach(element => {
            ...
            tempData = [
                no,
                kodeTampil,
                '<a href="{{ url("") }}/rkpd-perubahan-kegiatan/' + kodeOneData + '">' + element['rkpd_perubahan_program_nama'] + '</a>',
                element['rkpd_perubahan_program_indikator_nama'],
                element['rkpd_perubahan_program_indikator_formula'],
                element['satuan_nama'],
                element['rkpd_perubahan_program_indikator_target_kinerja'],
                element['rkpd_perubahan_program_indikator_target_realisasi'],
    ...
    function setForm(data) {
        ...
        $("input[name='rkpd_perubahan_program_kode']").val(data['rkpd_perubahan_program_kode']);
        $("input[name='rkpd_perubahan_program_nama']").val(data['rkpd_perubahan_program_nama']);
        $("textarea[name='rkpd_perubahan_program_ket']").val(data['rkpd_perubahan_program_ket']);
        $("textarea[name='rkpd_perubahan_program_indikator_nama']").val(data['rkpd_perubahan_program_indikator_nama']);
        $("textarea[name='rkpd_perubahan_program_indikator_formula']").val(data['rkpd_perubahan_program_indikator_formula']);
        $("select[name='id_satuan']").val(data['id_satuan']);
        $("input[name='rkpd_perubahan_program_indikator_target_kinerja']").val(data['rkpd_perubahan_program_indikator_target_kinerja']);
        $("input[name='rkpd_perubahan_program_indikator_target_realisasi']").val(data['rkpd_perubahan_program_indikator_target_realisasi']);
    }
