...
CREATE TABLE `rpjmd_misi` (
  ...
  `rpjmd_misi_nama` text DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rpjmd_program` (
  ...
  `rpjmd_program_nama` text DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rpjmd_sasaran` (
  ...
  `rpjmd_tujuan_kode` int(11) NOT NULL,
  `rpjmd_sasaran_kode` int(11) NOT NULL,
  `rpjmd_sasaran_nama` text DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rpjmd_sasaran_indikator` (
  ...
  `rpjmd_sasaran_indikator_nama` text DEFAULT NULL,
  `rpjmd_sasaran_indikator_iku_status` tinyint(4) NOT NULL,
  `rpjmd_sasaran_indikator_alasan` text DEFAULT NULL,
  `rpjmd_sasaran_indikator_formulasi` text DEFAULT NULL,
...
CREATE TABLE `rpjmd_triwulan` (
  ...
  `rpjmd_triwulan_ket` text DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rpjmd_tujuan` (
  ...
  `rpjmd_misi_kode` int(11) NOT NULL,
  `rpjmd_tujuan_kode` int(11) NOT NULL,
  `rpjmd_tujuan_nama` text DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rpjmd_tujuan_indikator` (
  ...
  `rpjmd_tujuan_indikator_nama` text DEFAULT NULL,
...
CREATE TABLE `rpjmd_visi_jabaran` (
  ...
  `rpjmd_visi_jabaran_isi` text DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
