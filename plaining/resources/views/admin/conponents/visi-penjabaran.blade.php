                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="{{ url('') }}/visi" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        <label>Jenis</label>
                        <input name="rpjmd_visi_jabaran_jenis" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Penjabaran</label>
                        <input name="rpjmd_visi_jabaran_isi" type="text" class="form-control" required>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            kodeOneData = element['kota_kode']+'-'+element['rpjmd_kode']+'-'+element['rpjmd_visi_jabaran_kode'];
            tempData = [
                no,
                element['rpjmd_visi_jabaran_jenis'],
                element['rpjmd_visi_jabaran_isi'],
    ...
    function getDataPilih(id){
        ...
        dataAll.forEach(element => {
            ...
            && setKode[2] == element['rpjmd_visi_jabaran_kode'] ){
                dataPilih = element;
                kode = id;
            }
        });
    ...
    function setForm(data){
        $("input[name='kode']").val(kode);
        $("input[name='rpjmd_visi_jabaran_jenis']").val(data['rpjmd_visi_jabaran_jenis']);
        $("input[name='rpjmd_visi_jabaran_isi']").val(data['rpjmd_visi_jabaran_isi']);
